...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { "name_theme": "teste", "description_theme": "teste" } }, as: :json
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { "name_theme": "teste", "description_theme": "teste" } }, as: :json
    assert_response 200
  end
